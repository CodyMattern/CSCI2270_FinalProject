...
namespace Riot
{
    ...
    void SummonerBST::printBestChamp() //display champion with highest KDA
    {
    ...
    bool SummonerBST::ifPlayed(const AggregatedStats& data) //used for filtering unplayed champion data
    {
    ...
    void SummonerBST::setSummonerStats(const ChampionStats& data) //accumulation of all data for this season
    {
    ...
    void SummonerBST::printSummonerStats(Season season) //display totals
    {
    ...
    string SummonerBST::getChampName(int champID) //calls key:value dictionary turn Champ ID into Champ Name
    {
    ...
    void SummonerBST::printSummonerBST(SummonerNode *x) //traverse the tree Alphabetically for easy to read information
    {
        if(x->left != NULL)
        {
