...
namespace Riot
{
	...
	namespace
	{
        const std::string BASE_URL = "https://na.api.pvp.net/api/lol/";
        const std::string BASE_STATIC_URL = "https://na.api.pvp.net/api/lol/static-data/";
        const std::string CHAMPION_API_VERSION = "/v1.2/";
        const std::string GAME_API_VERSION = "/v1.3/";
        const std::string LEAGUE_API_VERSION = "/v2.5/";
        const std::string STATIC_API_VERSION = "/v1.2/";
        const std::string STATS_API_VERSION = "/v1.3/";
